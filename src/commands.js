...
export function buildCommandBuilders() {
  ...
  withIntegerOption(pause, "bot", "OmniFM worker number (optional)", "OmniFM-Worker-Nummer (optional)");
  ...
  withIntegerOption(resume, "bot", "OmniFM worker number (optional)", "OmniFM-Worker-Nummer (optional)");
  ...
  withIntegerOption(stop, "bot", "OmniFM worker number (optional)", "OmniFM-Worker-Nummer (optional)");
  ...
  withIntegerOption(now, "bot", "OmniFM worker number (optional)", "OmniFM-Worker-Nummer (optional)");
  ...
  withIntegerOption(setvolume, "bot", "OmniFM worker number (optional)", "OmniFM-Worker-Nummer (optional)");
