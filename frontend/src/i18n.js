  ...
  de: {
    ...
    privacy: {
      ...
      sections: {
        ...
        analyticsBody: 'OmniFM bindet das Google-Tag G-J5X0ZZ5E3Z mit Consent Mode v2 ein. Standardmäßig ist analytics_storage auf denied gesetzt. Wenn du Analytics erlaubst, wird analytics_storage auf granted gesetzt und Google Analytics 4 kann Seitenaufrufe, technische Geräte-/Browserdaten, ungefähre Region, Referrer und Interaktionen verarbeiten. Anzeigen-Speicherung, personalisierte Werbung und Ad-User-Data bleiben deaktiviert. Empfänger ist Google Ireland Limited bzw. verbundene Google-Gesellschaften. Du kannst die Einwilligung jederzeit über die Cookie-Einstellungen widerrufen; dann wird Analytics wieder auf denied gesetzt und bekannte GA-Cookies werden gelöscht.',
        ...
        savedSongsTitle: 'Gemerkte Songs (Merkliste)',
        savedSongsBody: 'Wenn du im Now-Playing-Panel auf „Merken“ tippst, speichert OmniFM zu deiner Discord-ID den Song: Titel, Interpret, Sender, den Link zum Cover und den Zeitpunkt. Die Karte dazu bekommst du per Direktnachricht. Das passiert nur, wenn du selbst auf den Knopf tippst (Art. 6 Abs. 1 lit. b DSGVO). Es bleiben höchstens die letzten 50 Songs. Mit /merkliste siehst du deine Liste und löschst einzelne Songs oder alle auf einmal – danach ist davon nichts mehr gespeichert. Die Knöpfe zu Spotify, Apple Music, YouTube Music und Deezer öffnen nur eine Suche beim jeweiligen Anbieter; OmniFM schickt dorthin nichts.',
  ...
  en: {
    ...
    privacy: {
      ...
      sections: {
        ...
        analyticsTitle: 'Google Analytics 4',
        analyticsBody: 'OmniFM includes the Google tag G-J5X0ZZ5E3Z with Consent Mode v2. By default, analytics_storage is denied. If you allow analytics, analytics_storage is set to granted and Google Analytics 4 may process page views, technical device/browser data, approximate region, referrer, and interactions. Ad storage, personalized advertising, and ad user data remain disabled. The recipient is Google Ireland Limited or affiliated Google companies. You can withdraw consent at any time through the cookie settings; then analytics is set back to denied and known GA cookies are deleted.',
        ...
        savedSongsTitle: 'Saved songs (your list)',
        savedSongsBody: 'When you tap “Save” in the now-playing panel, OmniFM stores the song with your Discord ID: title, artist, station, the link to the cover and the time. You get the card as a direct message. This only happens when you tap the button yourself (Art. 6(1)(b) GDPR). At most the last 50 songs are kept. With /saved you see your list and delete single songs or all of them at once; after that nothing of it is stored. The buttons to Spotify, Apple Music, YouTube Music and Deezer only open a search at that service; OmniFM sends nothing there.',
