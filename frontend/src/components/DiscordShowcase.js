        ...
        <div className="ds-grid" style={{ display: 'grid', gridTemplateColumns: '0.9fr 1.1fr', gap: 56, alignItems: 'center' }}>
          <div>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 14px', borderRadius: 999, background: 'rgba(88,101,242,0.12)', border: '1px solid rgba(88,101,242,0.35)', marginBottom: 22 }}>
              ...
              <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 11, fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#aab2ff' }}>Direkt in Discord</span>
            </div>
            <h2 style={{ fontFamily: "'Syne','Outfit',sans-serif", fontWeight: 800, fontSize: 'clamp(28px,4vw,44px)', lineHeight: 1.08, letterSpacing: '-0.02em', marginBottom: 18 }}>
              Läuft im <span style={{ background: 'linear-gradient(120deg,#ff6b00,#00e5ff)', WebkitBackgroundClip: 'text', backgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Voice-Channel</span>, gesteuert per Slash-Command.
            </h2>
            <p style={{ color: '#94a3b8', fontSize: 17, lineHeight: 1.65, marginBottom: 26, maxWidth: 460 }}>
              Kein Browser-Player, kein Abspielen auf der Website. OmniFM streamt 24/7 direkt in deinen Discord-Voice-Channel – mit sauberen Now-Playing-Embeds, Buttons und Reconnect.
            </p>
            ...
            <div style={{ display: 'flex', gap: 14 }}>
              ...
              <div style={{ minWidth: 0, flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                  ...
                  <span style={{ color: '#949ba4', fontSize: 12 }}>heute um 21:14</span>
                </div>
                ...
                <div style={{ display: 'flex', background: '#2b2d31', borderRadius: 6, overflow: 'hidden', maxWidth: 440 }}>
                  ...
                  <div style={{ padding: '13px 15px', flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12 }}>
                      <div style={{ minWidth: 0 }}>
                        ...
                        <div style={{ display: 'flex', gap: 22, marginTop: 12, flexWrap: 'wrap' }}>
                          <div><div style={{ color: '#b5bac1', fontSize: 11, fontWeight: 700, textTransform: 'uppercase' }}>Genre</div><div style={{ color: '#dbdee1', fontSize: 13, marginTop: 2 }}>{s.genre}</div></div>
                          <div><div style={{ color: '#b5bac1', fontSize: 11, fontWeight: 700, textTransform: 'uppercase' }}>Bitrate</div><div style={{ color: '#dbdee1', fontSize: 13, marginTop: 2 }}>{s.bitrate}</div></div>
                    ...
                    <div style={{ marginTop: 12, height: 5, borderRadius: 999, background: '#1e1f22', overflow: 'hidden' }}>
                      <div style={{ height: '100%', width: '46%', background: 'linear-gradient(90deg,#ff6b00,#00e5ff)' }} />
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 6, color: '#949ba4', fontSize: 11, fontFamily: "'JetBrains Mono',monospace" }}>
                      <span># voice-radio</span><span>ON AIR · 24/7</span>
                    </div>
                  </div>
                </div>
